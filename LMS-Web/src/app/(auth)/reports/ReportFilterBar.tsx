...
export function toParams(reportId: ReportType, f: ReportFilters): ReportFilterParams {
...
export function isRunnable(reportId: ReportType, f: ReportFilters): boolean {
  const keys = REPORT_FILTERS[reportId];
